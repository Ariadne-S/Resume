                    ...
                    <div className="timeline">
                        ...
                        <div>
                            ...
                            <p>WORK180 is a fully remote start-up that works with employers to improve organizational
                                standards
                                that raise the bar for women in the workplace with a presence in Australia, United
                                Kingdom
                                and
                            ...
                            <h6>Smart Scraper</h6>
                            <p>Collaborated to plan and implement the "Smart Scraper" project - a database driven
                                scraper
                            ...
                            <p>Encaptualisated logic to remove duplication and simplify the configuration of Smart
                                Scraper
                                tests</p>
                ...
                <div>
                    ...
                    <div className="timeline">
                        ...
                        <div>
                            <h4>DressInspo</h4>
                            <h5>C# | SQL | React</h5>
                            <p>A large scale project, which I'm using to develop my programming skills, that aims to
                                bring
                                the
                                social aspect of wedding dress shopping online, and revolutionise the way brides and
                                their
                        ...
                        <div>
                            ...
                            <p>I undertook this project as a capstone course for my Bachelor of Arts. It is an
                                exploration
                                of a
                    ...
                    <div className="timeline">
                        ...
                        <div>
                            ...
                            <p className="less_bottom">Planned and undertook a social research project investigating the
                                social
                                cohesion of the Lendlease Community Yarrabilba and investigate whether people from
                                diverse
                        ...
                        <div>
                            ...
                            <ul>
                                <li>Learnt about cause and consequence, focusing on the study of people and their
                                    attitudes,
                                    motivations and prejudices. While developing professional skills including the
                                    ability
                                    to
